...
from dynamic_graph.sot.application.stabilizer.scenarii.pg_lqr_twoDof_coupled_stabilizer_hrp2_encoders import PgLqrTwoDofCoupledStabilizerHRP2Encoders
...
appli =  PgLqrTwoDofCoupledStabilizerHRP2Encoders(robot, False, False, False)
appli.sot.clear()
pg.CreateEverythingForPG ( robot , appli)

pg.walkAndrei(robot, appli)
appli.pg.velocitydes.value =(0.1,0.0,0.0)
